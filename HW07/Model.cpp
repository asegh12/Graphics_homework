...
void Model::draw(int loc_a_position, int loc_a_normal,  int loc_u_diffuse_texture, int loc_a_texcoord, int loc_u_ambient, int loc_u_diffuse, int loc_u_specular, int loc_u_shininess)
{
